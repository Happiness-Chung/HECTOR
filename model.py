...
class Conv3DBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bottleneck = False) -> None:
        ...
        self.relu = nn.ReLU()
        self.se1 = SEBlock3D(out_channels//2)
        self.se2 = SEBlock3D(out_channels)
    ...
    def forward(self, input):
        res = self.se1(self.relu(self.bn1(self.conv1(input))))
        res = self.se2(self.relu(self.bn2(self.conv2(res))))
        out = None
